  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-b from-indigo-900 via-indigo-950 to-sky-500 p-4">
        ...
        <div className="flex flex-col justify-center items-center gap-6 md:flex md:flex-row md:flex-wrap md:justify-center md:items-center md:gap-4">
          {[
            {
      ...
      <div className="md:flex md:flex-row md:justify-center md:items-center flex flex-col justify-center items-center gap-8 text-center border text-lg font-stretch-semi-condensed p-4">
